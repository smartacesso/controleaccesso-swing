...
public class DetectFaceResult {
	...
	Map<Integer, String> errors = new HashMap<Integer, String>() {{
		...
		put(-10, "N√£o foi possÌvel abrir o arquivo"); // FSDKE_CANNOT_OPEN_FILE
		put(-11, "N√£o foi possÌvel criar o arquivo"); // FSDKE_CANNOT_CREATE_FILE
		...
		put(-16, "Inicializa√ß√£o IP falhou"); // FSDKE_IP_INIT_FAILED
		put(-17, "Necessita ativa√ß√£o do servidor"); // FSDKE_NEED_SERVER_ACTIVATION
		...
		put(-30, "Exce√ß√£o no servidor"); // FSDKE_SERVER_EXCEPTION
		...
		put(-37, "Exce√ß√£o local"); // FSDKE_LOCAL_EXCEPTION
	}};
