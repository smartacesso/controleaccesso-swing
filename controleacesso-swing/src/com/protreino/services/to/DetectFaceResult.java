...
public class DetectFaceResult {
	...
	Map<Integer, String> errors = new HashMap<Integer, String>() {{
		...
		put(-2, "SDK n�o ativada"); // FSDKE_NOT_ACTIVATED
		...
		put(-22, "Versão de arquivo n�o suportada"); // FSDKE_UNSUPPORTED_FILE_VERSION
		...
		put(-26, "Versão do template n�o suportada"); // FSDKE_UNSUPPORTED_TEMPLATE_VERSION
		...
		put(-30, "Excess�o no servidor"); // FSDKE_SERVER_EXCEPTION
		...
		put(-36, "Usu�rio n�o est�o logado no servidor"); // FSDKE_USER_NOT_LOGGED_IN
		put(-37, "Excess�o local"); // FSDKE_LOCAL_EXCEPTION
	}};
