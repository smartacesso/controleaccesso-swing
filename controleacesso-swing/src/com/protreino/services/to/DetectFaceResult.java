...
public class DetectFaceResult {
	...
	Map<Integer, String> errors = new HashMap<Integer, String>() {{
		...
		put(-30, "Excessão no servidor"); // FSDKE_SERVER_EXCEPTION
		...
		put(-36, "Usuário não estão logado no servidor"); // FSDKE_USER_NOT_LOGGED_IN
		put(-37, "Excessão local"); // FSDKE_LOCAL_EXCEPTION
	}};
