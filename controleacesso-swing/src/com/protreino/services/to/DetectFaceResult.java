...
public class DetectFaceResult {
	...
	Map<Integer, String> errors = new HashMap<Integer, String>() {{
		...
		put(-9, "Extensão de arquivo n�o suportado"); // FSDKE_UNSUPPORTED_IMAGE_EXTENSION
		put(-10, "Não foi poss�vel abrir o arquivo"); // FSDKE_CANNOT_OPEN_FILE
		put(-11, "Não foi poss�vel criar o arquivo"); // FSDKE_CANNOT_CREATE_FILE
		...
		put(-22, "Versao de arquivo n�o suportada"); // FSDKE_UNSUPPORTED_FILE_VERSION
		put(-23, "Erro de sintaxe"); // FSDKE_SYNTAX_ERROR
		put(-24, "Parêmetro n�o encontrado"); // FSDKE_PARAMETER_NOT_FOUND
		put(-25, "Template inválido"); // FSDKE_INVALID_TEMPLATE
		put(-26, "Versao do template n�o suportada"); // FSDKE_UNSUPPORTED_TEMPLATE_VERSION
		put(-27, "índice da câmera n�o existe"); // FSDKE_CAMERA_INDEX_DOES_NOT_EXIST
		...
		put(-36, "Usu�rio n�o está logado no servidor"); // FSDKE_USER_NOT_LOGGED_IN
