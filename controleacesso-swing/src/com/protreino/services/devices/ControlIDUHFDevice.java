...
public class ControlIDUHFDevice extends ControlIdDevice {
	...
	public void createDefaultConfiguration(){
		...
		geralConfigurations.add(new ConfigurationTO("Tempo da requesi��o", "10000", FieldType.NUMERIC_LIST, "2000;1000;20000")); // inicio;passo;fim
		...
		geralConfigurations.add(new ConfigurationTO("Modo de opera��o", "cont", FieldType.COMBOBOX, "cont;trigger")); 
		...
		geralConfigurations.add(new ConfigurationTO("Usa l�gica de calculo de Entrada/Sa�da", "true", FieldType.CHECKBOX));
	...
	public void sendConfiguration() throws Exception {
		...
		Configuration configuration = new Configuration(serverIp, serverPort, serverId, 
			...
			getConfigurationValue("Tempo da requisi��o"), Integer.valueOf(getConfigurationValue("Bits de identifica��o")),
			getConfigurationValue("Ordem dos bytes"), Integer.valueOf(getConfigurationValue("Tempo de leitura (milissegundos)")),
			Integer.valueOf(getConfigurationValue("Tempo de leitura mesmo cartão  (milissegundos)")), Integer.valueOf(getConfigurationValue("Pot�ncia de transmiss�o")),
			getConfigurationValue("Canal de trabalho"), getConfigurationValue("Modo de opera��o"),
	...
	protected void registraGiro(Response notificacao) {
		...
		if(getConfigurationValueAsBoolean("Usa l�gica de calculo de Entrada/Sa�da"))
