...
public class ControlIdDevice extends Device {
	...
	public String cadastrateUser(PedestrianAccessEntity athleteAccessEntity){
		...
		try {
			...
			if (idsCriados == null || idsCriados.isEmpty()) {
				System.out.println("\n\r" + sdf.format(new Date()) + "  ------ CADASTRO DE USUARIO - Nao foi possivel criar o usuario: " + erro);
			...
			if (idsCriados == null || idsCriados.isEmpty()) {
				System.out.println("\n\r" + sdf.format(new Date()) + "  ------ CADASTRO DE USUARIO - Nao foi possivel criar o template: " + erro);
				...
				if (!device.isTheSame(this) 
					...
					if (device.isConnected() 
						...
						try {
							...
							if (idsCriados == null || idsCriados.isEmpty()) {
								System.out.println("\n\r" + sdf.format(new Date()) + "  ------ CADASTRO DE USUARIO - Nao foi possivel espelhar o usuario em " + device.getName());
							...
							if (idsCriados == null || idsCriados.isEmpty()) {
								...
								System.out.println("\n\r" + sdf.format(new Date()) + "  ------ CADASTRO DE USUARIO - Nao foi possivel espelhar o template em " + device.getName());
	...
	protected class User{
		...
		private String password;
		private String salt;
		private Integer begin_time; // opcional, Inteiro representando a partir de que data e hora (unix timestamp) o usuario é válido.
		private Integer end_time; // opcional, Inteiro rperesentando até que data e hora (unix timestamp) o usuario é válido.
