...
public class ControlIdDevice extends Device {
	...
	public void connect(String... args) throws Exception {
		try {
			if (login == null || password == null)
				throw new Exception("Login e senha são obrigat�rios.");
			            	...
			            	try {
			                    ...
			                    if (caminho.startsWith("/new_user_identified")
			                    	...
			                    	if (VerificationResult.ALLOWED.equals(verificationResult)) {
			                    		...
			                    		event = 3; // parâmetros de regra de identifica��o inválidos
	...
	protected void registraGiro(Response notificacao) {
		...
		String modoOperacao = getConfigurationValue("Modo de opera��o");
	...
	public void createDefaultConfiguration(){
		...
		geralConfigurations.add(new ConfigurationTO("Modo de opera��o", "Ambos bloqueados_blocked", FieldType.COMBOBOX,
		...
		geralConfigurations.add(new ConfigurationTO("Tempo da requisi��o", "10000", FieldType.NUMERIC_LIST, "2000;1000;20000")); // inicio;passo;fim
	...
	public String cadastrateUser(PedestrianAccessEntity athleteAccessEntity){
		...
		try {
			...
			// Verifica se serão necess�rio criar tambem em outras catracas ControlId
	...
	public String excluirUsuario(PedestrianAccessEntity acesso, Boolean sincronizarExclusao){
		try {
			...
			// Verifica se serão necess�rio apagar tambem em outras catracas ControlId
	...
	protected class User{
		...
		private String password;
		private String salt;
		private Integer begin_time; // opcional, Inteiro representando a partir de que data e hora (unix timestamp) o usu�rio � válido.
		private Integer end_time; // opcional, Inteiro rperesentando até que data e hora (unix timestamp) o usu�rio � válido.
