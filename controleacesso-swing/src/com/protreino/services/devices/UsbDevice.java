	...
	private class PlacaUSB {
		...
		public void liberaEntrada() {
			...
			try {
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel encontrar o dispositivo USB");
					return;
				}
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel comunicar com o dispositivo USB");
					return;
				}
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel abrir a porta 1");
					return;
				}
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel abrir a porta 2");
					return;
				}
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel fechar a porta 2");
					return;
				}
				...
				if (!comandoEnviado) {
					Main.mainScreen.addEvento("Nao foi possivel fechar o dispositivo USB");
					return;
				}
