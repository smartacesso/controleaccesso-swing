...
public class Utils {
	...
	public static void defineDefaultPreferences() {
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, "toleranceAccess",
				"Toler�ncia de entrada e sa�da (em minutos)", FieldType.NUMERIC_LIST, "0", "0;1;20"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, "minTimeBetweenAccess",
				"Tempo m�ximo entre entradas (em minutos)", FieldType.NUMERIC_LIST, "0", "0;1;20"));
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, "messageNotAllowedSensor",
				"Mensagem para pedestre que n�o depositou cartão na urna", FieldType.TEXT,
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, "messageNotAllowedBox",
				"Mensagem de cartão n�o permitido na urna", FieldType.TEXT, "N�o permitido;na urna."));
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.ATHLETE_SCREEN, "athleteScreenTimeout",
				"Tempo limite para apresenta��o dos dados (segundos)", FieldType.NUMERIC_LIST, "5", "5;5;60"));
...
//			olhar a posi��o pegar exatamente o mesmo if
			String fcWiegand = "";
			String temp = "";
			...
			System.out.println("N�o foi poss�vel converter cartão " + Cartao + "\n motivo " + e.getMessage());
			return Cartao;
		}
