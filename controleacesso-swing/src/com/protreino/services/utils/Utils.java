...
public class Utils {
	...
	public static void defineDefaultPreferences(){
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"scrollSpeed", "Velocidade de rolagem", FieldType.TEXT, "5", true, 12));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"toleranceAccess", "Tolerância de entrada e saída (em minutos)", FieldType.NUMERIC_LIST, "0", "0;1;20"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL,
				"minTimeBetweenAccess", "Tempo mínimo entre entradas (em minutos)", FieldType.NUMERIC_LIST, "0", "0;1;20"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"timeAccessList", "Tempo de atualização da lista de acesso (em minutos)", FieldType.TEXT, "2", true, 10));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL,
				"timeUserAccessList", "Tempo de atualização das lista de usuários (em minutos)", FieldType.TEXT, "2", true, 10));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"printLog", "Imprimir log com o servidor", FieldType.CHECKBOX, "false"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"releaseAccessRequiresPassword", "Exigir senha de administrador para liberação de acesso", FieldType.CHECKBOX, "false"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"releaseAccessReason", "Motivos para liberação de acesso (separados por virgula)", FieldType.TEXT, "", false, 25));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"imageSizeRequestServer", "Tamanho das fotos recebidas do servidor (dimensão em px)", FieldType.TEXT, "48", true, 10));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"registerAccessWithoutConnectedDevices", "Registrar acesso mesmo que não haja dispositivos conectados", FieldType.CHECKBOX, "false"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"pedestrianAlwaysOpen", "Cadastro de pedestre/visitante em série", FieldType.CHECKBOX, "false"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"hourAutomaticRoutines", "Hora para execução das rotinas automáticas", FieldType.NUMERIC_LIST,  "00","0;1;23"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES,
				"messageExitAllowed", "Mensagem de saída permitida", FieldType.TEXT, "SAIA"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowed", "Mensagem de acesso negado", FieldType.MESSAGE_LINES, "PEDESTRE;NAO PERMITIDO"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotFound", "Mensagem de pedestre não encontrado", FieldType.MESSAGE_LINES, "PEDESTRE;NAO ENCONTRADO"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageAllowedOnlyOnce", "Mensagem de pedestre que já acessou no dia", FieldType.MESSAGE_LINES, "PEDESTRE JA;REGISTRADO HOJE"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedToday", "Mensagem de pedestre fora do dia permitido", FieldType.MESSAGE_LINES, "PEDESTRE NAO;PERMITIDO HOJE"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedNow", "Mensagem de pedestre fora do horário permitido", FieldType.MESSAGE_LINES, "PEDESTRE NAO;PERMITIDO AGORA"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageError", "Mensagem de erro na verificação", FieldType.MESSAGE_LINES, "ERRO NA;VERIFICACAO"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageTolerancePeriod", "Mensagem de pedestre no período de tolerância", FieldType.MESSAGE_LINES, "BEM-VINDO;PLANO VENCIDO"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				...
				FieldType.TEXT, "Não permitido. Procure a secretaria."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES,
				"messageNotAllowedFaceRequired", "(Tela do pedestre) Mensagem de cadastro de face obrigatário", 
				FieldType.TEXT, "Obrigatório cadastro facial"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageAllowedOnlyOnceAthleteScreen", "(Tela do pedestre) Mensagem pedestre que já acessou no dia", 
				FieldType.TEXT, "Não permitido mais hoje."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedTodayAthleteScreen", "(Tela do pedestre) Mensagem fora do dia permitido", 
				FieldType.TEXT, "Fora do dia permitido."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedNowAthleteScreen", "(Tela do pedestre) Mensagem fora do horário permitido", 
				FieldType.TEXT, "Fora do horário permitido."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedOrigem", "Mensagem para pedestre não permitido nesse equipamento", 
				FieldType.TEXT, "Não permitido;no equipamento."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES, 
				"messageNotAllowedSensor", "Mensagem para pedestre que não depositou cartão na urna", 
				FieldType.TEXT, "Deposite;o cartao na urna."));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES,
				"messageSMSAfterPassInDevice", "Mensagem SMS após passagem na catraca",
				FieldType.TEXT, "Acabou de passar na catraca"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.MESSAGES,
				"messageNotAllowedBox", "Mensagem de cartão não permitido na urna", 
				FieldType.TEXT, "Não permitido;na urna."));
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.ATHLETE_SCREEN, 
				"athleteScreenFirstColor", "Cor primária da tela do pedestre", FieldType.COLOR_CHOOSER, 
				(Main.firstColor.getRed() + ";" + Main.firstColor.getGreen() + ";" + Main.firstColor.getBlue())));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.ATHLETE_SCREEN, 
				"athleteScreenSecondColor", "Cor secundária da tela do pedestre", FieldType.COLOR_CHOOSER,
				(Main.secondColor.getRed() + ";" + Main.secondColor.getGreen() + ";" + Main.secondColor.getBlue())));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.ATHLETE_SCREEN, 
				"athleteScreenTimeout", "Tempo limite para apresentação dos dados (segundos)", 
				FieldType.NUMERIC_LIST, "5", "5;5;60"));
		
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.FACE_RECOGNIZER, 
				"samplesNumberForTraining", "Número de amostras para treinamento", FieldType.NUMERIC_LIST, "1", "1;1;10"));
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.FACE_RECOGNIZER,
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.FACE_RECOGNIZER,
				"waitTimeAfterRecognizer", "Tempo de espera após reconhecimento (em ms)", 
		...
		defaultPreferencesList.add(new PreferenceTO(PreferenceGroup.GENERAL, 
				"cardMaster", "Definir número do cartão Master", FieldType.TEXT, "", true, 12));
	 ...
	 * backup precisa ser enviado. Com isso, haver� nova tentativa juntamente com o envio dos logs de acesso
	 */
