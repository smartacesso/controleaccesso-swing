...
public class Download extends Observable implements Runnable {
	...
	public Download(URL url, String fileLocation, String fileName) {
		this.url = url;
	...
	public void run() {
		...
		try {
			...
			fileTemp.mkdirs();
			fileTemp = new File(fileLocation + fileName);
	...
	private void stateChanged() {
		setChanged();
		notifyObservers();
		//System.out.println("Status: " + status + "   Size: " + size + "   Downloaded: " + downloaded);
	}
}
