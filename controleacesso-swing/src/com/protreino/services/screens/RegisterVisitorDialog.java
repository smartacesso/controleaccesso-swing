...
//		});
    ...
    private JPanel montarPainelAcoes() {
    	syncInHikivisionButton = new JButton("Sincronizar nas camÍras");
      ...
      /*  if(bloquearCartaoZerado) {  	
        	if (cartaoAcessoTextField != null
        		...
        		if (cartaoAcessoTextField.getText().matches(
        				"^0+$")) {
        			cartaoAcessoLabel.setText(" Cart„o zerado");
        			redAndBoldFont(cartaoAcessoLabel);
        			valido = false;
        		}
        	}	
...
//		se j·, o cart„o √© removido da pessoa exluida e j· atribuido ao novo
    ...
    private void criarDialogoServidorHikivisionNaoConectado() {
        ...
        hivisionServerNaoConectadoDialog.setTitle("Servidor Hikivision n„o conectado");
        ...
        JLabel mensagemLabel = new JLabel("Servidor para cadastro facial indisponÌvel, n„o È possÌvel cadastrar fotos para os pedestres");
        mensagemLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    private void criarDialogoFotoInvalida() {
        ...
        hivisionServerNaoConectadoDialog.setIconImage(Main.favicon);
        hivisionServerNaoConectadoDialog.setModal(true);
        hivisionServerNaoConectadoDialog.setTitle("Foto inv·lida");
        hivisionServerNaoConectadoDialog.setResizable(false);
        hivisionServerNaoConectadoDialog.setLayout(new BorderLayout());
        ...
        JLabel mensagemLabel = new JLabel("Foto inv·lida, Tente novamente!");
        mensagemLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
...
//		int novaAltura = (int) (srcImg.getHeight() / fatorDeReducao);
    ...
    private void criarDialogoConfirmarAddCredito() {
        ...
        JLabel mensagemLabel = new JLabel("Tem certeza que deseja adicionar um crÈdito para este visitante?");
        mensagemLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
