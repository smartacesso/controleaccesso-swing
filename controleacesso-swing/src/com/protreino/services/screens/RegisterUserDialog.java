	...
	public void cadastrarOuRemoverUsuario(String tipoOperacao, PedestrianAccessEntity pedestre) { // tipoAlteracao = "CADASTRO" ou "EXCLUSAO"
		...
		if (cadastroFeitoDiretamenteNaCatraca) {
			instrucoesDialog1 = "CADASTRO".equals(tipoOperacao) 
					? "Cadastre um novo usu�rio diretamente na catraca com o Código" 
							: "Remova diretamente da catraca o usu�rio de Código";
...
//			}
					...
					try {
						...
						if ("".equals(retorno)) {
							...
							if (retorno.contains("PRIMARY KEY")) {
								mensagemErroRetorno = "Código j� est� cadastrado.";
							}
						}
					} catch (Exception e) {
			...
			// Adicionar um botao para cancelar a adi��o quando for poss�vel
