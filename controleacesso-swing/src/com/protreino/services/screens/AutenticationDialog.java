	...
	public AutenticationDialog(Frame owner, boolean useLogin, boolean usePassword, boolean loginInterno){
		...
		Action okAction = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				//IDENTIFICAR QUEM ESTï¿½ CHAMANDO A TELA
				if(loginInterno) {
					...
					if(planoComMaiorVencimento == null
						...
						invalidCredentialsLabel.setText("Login nÃ£o permitido. Verifique com o administrador do sistema.");
						return;
					}
		...
		try {
			...
			SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
			    ...
			    public Boolean doInBackground() {
			    	...
			    	//	fazer o enable se nÃ£o achar motivo para sennha
