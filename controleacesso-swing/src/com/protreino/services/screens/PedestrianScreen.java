...
//				catracasCombobox.addItem(new SelectItem(commDevice.getName(), commDevice));
	 ...
	 * @param matchedAthleteAccess
	 */
	public void requisicaoPorCodigo(final VerificationResult verificationResult, final String allowedUserName,
			final PedestrianAccessEntity matchedAthleteAccess) {
		SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
			@Override
			protected Void doInBackground() throws Exception {
				loadingDialog.setVisible(true);
				try {
					PedestrianScreen.this.resultadoVerificacao = verificationResult;
					PedestrianScreen.this.allowedUserName = allowedUserName;
					PedestrianScreen.this.matchedAthleteAccess = matchedAthleteAccess;
